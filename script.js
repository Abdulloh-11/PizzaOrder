...
var renderFunction = (array, element) => {
  ...
  for (var i = 0; i < array.length; i++) {
    element.innerHTML += `
<li class="spat">
            <p class="qwe">Order: ${array[i].id}</p>
            <p class="qwe">User name: ${array[i].name}</p>
            <p class="qwe">Phone number: ${array[i].phone}</p>
            <p class="qwe">Adress: ${array[i].email}</p>
                <hr class="hrr">
            <p class="qwe">Dough thickness: ${array[i].thick}</p>
            <p class="qwe">Size: ${array[i].size}</p>
            <p class="qwe">On pizza: ${array[i].on}</p>
            <p class="qwe">Add: ${array[i].add}</p>
            <hr class="hrr">
